...
const localesJsonPath = path.join(__dirname, '../../lib/elixon/web/javascript/mastodon/locales');
...
locales.forEach(locale => {
  ...
  const localeDataPath = [
    ...
    `../../lib/elixon/web/javascript/mastodon/locales/locale-data/${baseLocale}.js`,
...
//
import messages from '../../lib/elixon/web/javascript/mastodon/locales/${locale}.json';
import localeData from ${JSON.stringify(localeDataPath)};
import { setLocale } from '../../lib/elixon/web/javascript/mastodon/locales';
