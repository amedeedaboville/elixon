...
const localesPath = '../../lib/web/javascript/mastodon/locales';
const localesJsonPath = path.join(__dirname, localesPath);
...
locales.forEach(locale => {
  ...
  const localeDataPath = [
    ...
    `${localesPath}/locale-data/${baseLocale}.js`,
...
//
import messages from '${localesPath}/${locale}.json';
import localeData from ${JSON.stringify(localeDataPath)};
import { setLocale } from '${localesPath}';
